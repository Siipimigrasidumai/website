...
require 'page/jenisbarang/functionjenis.php';
require 'page/satuanbarang/functionsatuan.php';
if (!isset($_SESSION['user_id'])) {
  // Jika tidak di-set, artinya user belum login
  // Lakukan aksi yang sesuai jika user belum login, misalnya redirect ke halaman login
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index3.php">
        ...
        <div class="sidebar-brand-text mx-2">KANTOR IMIGRASI</div>
      </a>
  ...
  <!--sidebar start-->
    ...
    <li class="d-flex align-items-center justify-content-center">
        ...
        <a class="nav-link">
			...
			<div class="d-flex align-items-center justify-content-center" class="email">Hai  <?php echo $data['nama'];?> !</div>
		 </a>
      </li>
...
<script type="text/javascript">
    ...
    $('#Myform3').submit(function() {
        $.ajax({
            type: 'POST',
            url: 'page/laporan/cetakkeluar.php',
            data: $(this).serialize(),
            success: function(data) {
             $(".tampung3").html(data);
             $('.table').DataTable();
